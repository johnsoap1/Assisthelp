...
@app.on_chat_member_updated(filters.chat(ChatType.GROUP), group=welcome_captcha_group)
@capture_err
...
@app.on_message(filters.command("captcha") & ~filters.chat(ChatType.PRIVATE))
...
@app.on_message(filters.command("set_welcome") & ~filters.chat(ChatType.PRIVATE))
...
@app.on_message(filters.command("del_welcome") & ~filters.chat(ChatType.PRIVATE))
@adminsOnly("can_change_info")
...
@app.on_message(filters.command("get_welcome") & ~filters.chat(ChatType.PRIVATE))
@adminsOnly("can_change_info")
