...
@app.on_message(filters.command("filter") & ~filters.chat(ChatType.PRIVATE))
...
@app.on_message(filters.command("filters") & ~filters.chat(ChatType.PRIVATE))
@capture_err
...
@app.on_message(filters.command("stop") & ~filters.chat(ChatType.PRIVATE))
@adminsOnly("can_change_info")
